...
public class GreetResource {
  ...
  public Response greet(@Parameter(description = "name", schema = @Schema(type = SchemaType.STRING), example = "Stephan") @PathParam("name") final String name) {
    LOG.info("Greet {}", name);
  ...
  @RequestBody(name = "greeting", content = @Content(schema = @Schema(implementation = GreetingDTO.class)))
